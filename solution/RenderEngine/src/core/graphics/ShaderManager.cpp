...
void ShaderManager::setVec2(Shader* shader, ShaderVariables::Type variableKey, const float* value)
{
    this->graphicsWrapper->setVec2(shader->program, shader->variableLocations[variableKey], value);
}
