...
namespace sre
{
	...
	template <> std::size_t SRE_API getComponentId<class SpriteMaterialComponent>() { return EComponentId::SPRITE_MATERIAL; }
	...
	template <> std::size_t SRE_API getComponentId<class SpriteRendererComponent>() { return EComponentId::SPRITE_MATERIAL; }
